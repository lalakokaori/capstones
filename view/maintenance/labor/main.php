...
<!--**********************************-->
                ...
                <div class="col-md-12">
                    <h4 class="page-head-line">Labor</h4>
                        <div class="panel-body">
                            <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" onclick="reset();">
                              Add New Record
                            </button>
                            <a href="../categories/main.php?types=labor"><button class="btn btn-primary btn-lg" data-toggle="modal">
                              Category
                            </button></a>
                            </div>
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Labor Form </h4>
                                        </div>
...
<!--**********************************-->
    ...
    <script src="../../../controller/labors.js" type="text/javascript"></script>
