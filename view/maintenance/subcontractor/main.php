...
<!--**********************************-->
                ...
                <div class="col-md-12">
                    <h4 class="page-head-line">Subcontractor</h4>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Subcontractor Form </h4>
                                        </div>
...
<!--**********************************-->
                            ...
                            <table id="table_main" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Contact Person w\ Contact Number</th> 
                                        <th>Scope of Work</th>   
    ...
    <script src="../../../controller/subcontractor.js" type="text/javascript"></script>
