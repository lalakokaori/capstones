...
function validate_form(){
	...
	if($('#f_position').val()==''){
		err = true;
		$('#f_position_div').addClass('has-error');
	}
	else
		$('#f_position_div').removeClass('has-error');
...
$('#btn_save').click(function(){
	...
	if(validate_form()==true){}
		...
		var dataString = 'name='+name+'&contact='+contact+'&person='+person+'&position='+position+'&address='+add+'&email='+email;
